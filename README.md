...
Чтобы быстро загрузить данные о конкретном месте, необходимо выполнить команду терминале (находясь в папке проекта):
```
python manage.py http://адрес/файла.json
```
